  ...
  <v-container id="quality-assurance">
    ...
    <v-container>
      ...
      <v-row ref="round-data">
        <v-col>
          ...
          <v-card style="height: 100%">
            ...
            <v-card-text>
              <v-text-field value="External QA:" disabled />
              <v-text-field
                label="Vendor ID:"
              ...
              />
              <hr />
              <v-text-field value="Internal QA:" disabled />
              <v-text-field
      ...
      <v-row style="margin-top: 10px">
        <h2 style="text-align: left">Manage Quality Assurance Process</h2>
      </v-row>
          ...
          <v-container>
            <v-col align="start">
              <v-tooltip bottom color="black">
                ...
                <span
                  >QA Companys: External and internal quality assurance are
                  possible.</span
                ><br />
                <span
                ...
                ><br />
                <span
                  >External Quality: The quality of QA work of the external QA
                  department.</span
                ><br />
                <span
                  >Internal Quality: The quality of work of the QA department
                  employees.</span
                >
                <span
                  >QA Capacity: Number of bikes that can undergo the QA process.
                  It is not possible to sell a bike without quality
                  assurance.</span
                ><br />
                <span
                  >Cost Per Year: Total cost of all of employees from the QA
                  department/the cost of outsourcing.</span
                >
              </v-tooltip>
            </v-col>
          </v-container>
          ...
          <v-container>
            <v-col align="start">
              <v-tooltip bottom color="black">
                ...
                <span
                  >If you have decided to choose Digital Twin earlier in the
                  game, for instance</span
                >
                <span
                  >inside preperation materials, you should now NOT take
                  external Quality Assurance.</span
                ><br />
          ...
          <v-row align="center" justify="center">
            <v-radio-group row>
              <v-radio
                ...
                label="Internal QA"
                value="radio-1"
                v-on:click="toggleInternal"
              ></v-radio>
              <v-radio
                id="internalQA"
                label="External QA"
                value="radio-2"
                v-on:click="toggleExternal"
              ></v-radio>
            </v-radio-group>
          </v-row>
        </v-container>
      ...
      <v-row style="margin-top: 10px">
        <h2 style="text-align: left">Digittal Twins & Learning Video</h2>
      </v-row>

      <v-row class="mt-6 mb-6">
        <youtube
          :video-id="videoId"
          ref="https://www.youtube.com/watch?v=Szjz_4QY628"
          @playing="playing"
        ></youtube>
      </v-row>
...
export default {
  ...
  computed: {
    ...
    returnDigitalTwinQuality: function () {
      return this.amountDigitalTwinQuality >= 0
        ? this.amountDigitalTwinQuality
        : 0;
    },
    ...
    returnNumEployees: function () {
      return this.amountNumberofemployees >= 0
        ? this.amountNumberofemployees
        : 0;
    },
    ...
    getLastEmployeesatisfaction: function () {
      return this.lastVendor != null
        ? this.lastVendor.Employeesatisfaction
        : "No Data";
    },
    ...
    getLastNumberofemployees() {
      return this.lastVendor != null
        ? this.lastVendor.Numberofemployees
        : "No Data";
    },
    getLastCapacity: function () {
      return this.lastVendor != null
        ? this.lastVendor.Numberofemployees * 50000
        : "No Data";
    },
    getLastDigitaltwinquality: function () {
      return this.lastVendor != null
        ? this.lastVendor.Digitaltwinquality
        : "No Data";
    },
    getVendor: function () {
    ...
    calculatedCosts: function () {
      return this.amountNumberofemployees >= 0
        ? this.amountNumberofemployees * 40433
        : 0;
    },
    calculatedCapacity: function () {
      return this.amountNumberofemployees >= 0
        ? this.amountNumberofemployees * 50000
        : 0;
    },
  ...
  methods: {
    ...
    async toggleDialog() {
      if (this.internalQA == true && this.externalQA == false) {
        if (
          this.amountInternalQuality == 0 &&
          this.amountNumberofemployees == 0
        ) {
