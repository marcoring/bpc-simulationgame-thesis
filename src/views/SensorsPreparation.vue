  ...
  <v-container id="sensors-preparation">
    ...
    <v-container align="left">
      <v-row align="start"
        ...
        <v-icon color="white" x-large>mdi-chip</v-icon>
        </v-btn>
        <v-col align="start"
            justify="start"
            class="mb-6 ml-4">
        <h1 class="font-weight-black">Sensors Preparation</h1>
        </v-col>
      </v-row>
    </v-container>
  ...
  <v-row ref="round-data">
        ...
        <v-card style="height:100%">
          ...
          <v-card-text>
            ...
            :value="lastProductcustomization != null ? lastProductcustomization : 'No Data'"
            disabled
            />
            <v-text-field
    ...
    <v-row style="margin-top: 15px; margin-left: 3px">
      <h2 style="text-align: left;">
        Manage Sensors Preparation Process
      </h2>
    </v-row>
