<template>
  <v-container id="logistics">
        ...
        <v-card style="height: 100%">
          ...
          <v-card-text>
            ...
            <v-text-field
              ...
              :value="
                lastCalculatedDeliveryCosts != null
                  ? lastCalculatedDeliveryCosts
                  : 'No Data'
              "
              disabled
            />
            <v-text-field
              ...
              :value="
                lastCalculatedDeliveryQuality != null
                  ? lastCalculatedDeliveryQuality
                  : 'No Data'
              "
              disabled
            />
            <v-text-field
              ...
              :value="
                lastCalculatedSustainabilityfactor != null
                  ? lastCalculatedSustainabilityfactor
                  : 'No Data'
              "
              disabled
            />
            <v-text-field
              ...
              :value="
                lastCalculatedRegionalityfactor != null
                  ? lastCalculatedRegionalityfactor
                  : 'No Data'
              "
              disabled
            />
    ...
    <v-row
      v-if="this.$store.state.logisticStep <= 4"
      class="pa-2"
          ...
          <v-container>
            <v-col align="start">
              <v-tooltip bottom color="black">
                ...
                ><br /><br />
                <span
                  >Implementation Costs for Smart Logistics only occur
                  once!</span
                ><br />
              </v-tooltip>
            </v-col>
          ...
          <v-container>
            <v-col align="start">
              <v-tooltip bottom color="black">
                ...
                <span
                  >Transportation Company: Transportation companies differ in
                  quality and price.</span
                ><br />
                <span
...
export default {
  ...
  computed: {
    ...
    lastCalculatedDeliveryQuality: function () {
      return this.lastVendor != null
        ? this.lastVendor.Deliveryquality
        : "No Data";
    },
  ...
  methods: {
    ...
    logicStep() {
      this.stepText =
        "Choose here your logistic partner here. Compare different metrics and decide what partner do you want to have!";
