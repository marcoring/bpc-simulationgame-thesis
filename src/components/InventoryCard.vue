  ...
  <div>
    ...
    <v-col align="end">
      <v-tooltip bottom :color="teamColor">
        ...
        <span>These data show the inventory carried over from the previous round and the corresponding warehousing cost included in this rounds runningcost.</span><br>
      </v-tooltip>
    </v-col>
    </v-card-title>
...
export default {
  ...
  computed: {
    ...
    getBattery: function() {
      ...
      return this.gameDataInventory != null ? this.gameDataInventory.Amountbat : 0;
    },
    getEngine: function() {
      return this.gameDataInventory != null ? this.gameDataInventory.Amounteng : 0;
    },
     getFrame: function() {
      return this.gameDataInventory != null ? this.gameDataInventory.Amountfr : 0;
    },
    getSensors: function() {
      return this.gameDataInventory != null ? this.gameDataInventory.Amountsen : 0;
    },
    getBatteryGranulate: function() {
      return this.gameDataInventory != null ? this.gameDataInventory.Amountbatgr : 0;
    },
    getEngineGranulate: function() {
      return this.gameDataInventory != null ? this.gameDataInventory.Amountenggr : 0;
    },
    getFrameGranulate: function() {
      return this.gameDataInventory != null ? this.gameDataInventory.Amountfrgr : 0;
    },
    getSensorsGranulate: function() {
      return this.gameDataInventory != null ? this.gameDataInventory.Amountsengr : 0;
    },
    getBatteryPrepared: function() {
      return this.gameDataInventory != null ? this.gameDataInventory.Amountprodbat : 0;
    },
    getEnginePrepared: function() {
      return this.gameDataInventory != null ? this.gameDataInventory.Amountprodsen : 0;
    },
     getFramePrepared: function() {
      return this.gameDataInventory != null ? this.gameDataInventory.Amountprodfr : 0;
    },
    getSensorsPrepared: function() {
      return this.gameDataInventory != null ? this.gameDataInventory.Amountprodsen : 0;
    },
    getBikesBeforeQA: function() {
      return this.gameDataInventory != null ? this.gameDataInventory.Amountcon : 0;
    },
     getBikesAfterQA: function() {
      return this.gameDataInventory != null ? this.gameDataInventory.Amountqa: 0;
    },
