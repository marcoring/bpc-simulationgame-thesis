<template>
  <v-dialog
    ...
    :persistent="!roundRulesCanbeClosed"
  >
    <v-card id="roundRulesCard">
      ...
      <v-card-actions>
        <v-spacer />
        <v-btn
          v-if="this.roundRulesCanbeClosed"
          color="red"
          @click="closeDialog"
          dark
          text
  ...
  data() {
    return {
      ...
      rules: {
        ...
        round3Rules: "Welcome to round 3! Check out these new features:",
        round3Keywords: [
        ...
        round4Rules: "Welcome to round 4!",
        round4Keywords: [
