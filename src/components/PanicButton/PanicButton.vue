<template>
  <v-dialog v-model="dialog" width="50%" @click:outside="closeDialog">
    <v-card>
      <v-card-title class="headline grey lighten-2"> Panic! </v-card-title>
      ...
      <v-card-text>
        ...
        <p v-else class="text-font">
          Do you really want to send a notification to admin?
        </p>
      </v-card-text>
      ...
      <v-card-actions>
        ...
        <v-btn
          ...
          :color="teamColor"
          text
          @click="sendNotificationToServer"
        >
          <b>Send</b>
        </v-btn>
      </v-card-actions>
