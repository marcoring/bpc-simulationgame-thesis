...
const actions = {
    async getLastVendor({getters, commit, rootGetters}) {
      ...
      var response = await axios.get(
          `http://z40lp1.informatik.tu-muenchen.de:8000/sap/opu/odata/sap/Z_40_T2_BIKEGAME_ACF_SRV/AppdevProcessSet(Guid=guid'${rootGetters.gameData.Guid}',Roundid=${rootGetters.gameData.Roundid - 1},Userid='${rootGetters.gameData.Userid}')?$format=json`
        );
    ...
    async saveVendor({ commit, dispatch, getters, rootGetters }) {
      ...
      const axiosConfig = {
        ...
        var response = await axios.put(
            `http://z40lp1.informatik.tu-muenchen.de:8000/sap/opu/odata/sap/Z_40_T2_BIKEGAME_ACF_SRV/AppdevProcessSet(Guid=guid'${rootGetters.gameData.Guid}',Roundid=${rootGetters.gameData.Roundid},Userid='${rootGetters.gameData.Userid}')`,
                payload_without_bs
              ,
              {
                axiosConfig
