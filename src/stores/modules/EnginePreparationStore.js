  ...
  const actions = {
    async getLastVendor({commit, rootGetters}) {
      ...
      var response = await axios.get(
          `http://z40lp1.informatik.tu-muenchen.de:8000/sap/opu/odata/sap/Z_40_T2_BIKEGAME_ACF_SRV/ProdProcessSet(Guid=guid'${rootGetters.gameData.Guid}',Roundid=${rootGetters.gameData.Roundid - 1},Materialid='ENG',Userid='${rootGetters.gameData.Userid}')?$format=json`
        );
    ...
    async saveVendor({ commit, dispatch, getters, rootGetters }, data) {
      ...
      const axiosConfig = {
        ...
        var response = await axios.put(
            `http://z40lp1.informatik.tu-muenchen.de:8000/sap/opu/odata/sap/Z_40_T2_BIKEGAME_ACF_SRV/ProdProcessSet(Guid=guid'${rootGetters.gameData.Guid}',Roundid=${rootGetters.gameData.Roundid},Userid='${rootGetters.gameData.Userid}',Materialid='ENG')`,
                payload_without_bs,
